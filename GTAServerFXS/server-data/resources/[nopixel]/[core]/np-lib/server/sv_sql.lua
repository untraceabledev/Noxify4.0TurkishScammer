...
SQL.scalar = function(qyery, ...)
    ...
    exports["np-db"]:scalar(query, { ... }, function(qResult) qPromise:resolve(qResult) end)
...
SQL.execute = function(q, ...)
    ...
    exports["np-db"]:execute(q, {...}, function(qResult) qPromise:resolve(qResult) end)
...
SQL.dynamicInsert = function(tableName, data, pReplaceInto)
    ...
    exports["np-db"]:execute(query, {}, function(qResult) qPromise:resolve(qResult) end)
