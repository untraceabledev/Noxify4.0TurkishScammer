...
-- FIXME: Convert to new inventory (or otherwise replace functionality of stopping phone call when phone is removed from inventory)
...
AddEventHandler('np-inventory:itemCheck', function(itemId, hasItem)
  ...
  for _, item in ipairs(phoneItems) do
    hasPhone = exports['inventory']:hasEnoughOfItem(item, 1, false, true) or hasPhone
  end
