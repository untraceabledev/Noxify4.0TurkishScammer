...
RegisterNetEvent('phone:emailReceivedItemCheck')
AddEventHandler('phone:emailReceivedItemCheck', function(sender, subject, body, opts, itemCheck)
  local hasItem = exports["inventory"]:hasEnoughOfItem(itemCheck, 1, false, true)
  if not hasItem then return end

  TriggerEvent("phone:emailReceived", sender, subject, body, opts)
end)
