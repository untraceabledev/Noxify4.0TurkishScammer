PlayerPed, CurrentTarget, CurrentTargetCoords, IsInVehicle, insideInterior = nil, nil, nil, false, false
...
AddEventHandler('np-editor:insideInteriorZone', function(inside)
...
Citizen.CreateThread(function()
    while true do
        ...
        local entity, entityType, entityCoords = GetEntityPlayerIsLookingAt(3.0, 0.2, flag, PlayerPed)
...
exports('GetCurrentTargetCoords', function ()
    return CurrentTargetCoords
end)
