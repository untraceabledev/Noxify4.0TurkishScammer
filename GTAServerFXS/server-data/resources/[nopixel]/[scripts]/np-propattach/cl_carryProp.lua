...
attachPropList = {
	...
	["umbrella01"] = { 
        ["model"] = "p_amb_brolly_01", ["bone"] = 57005, ["x"] = 0.1,["y"] = 0.00,["z"] = -0.025,["xR"] = -90.0,["yR"] = 0.0, ["zR"] = 0.0 
    },
	...
	["radio_civ"] = {
		["model"] = "np_radio_civ", ["bone"] = 57005, ["x"] = 0.14,["y"] = 0.01,["z"] = -0.02,["xR"] = 180.0,["yR"] = 30.0, ["zR"] = 90.0
	},
	...
	["np_prop_cs_walking_stick"] = {
		["model"] = "np_prop_cs_walking_stick", ["bone"] = 60309, ["x"] = 0.075,["y"] = 0.03,["z"] = 0.00,["xR"] = 160.0,["yR"] = 255.0, ["zR"] = 0.0
	  },
	...
	["props_news_boommic"] = {
		["model"] = "props_news_boommic", ["bone"] = 57005, ["x"] = 0.1,["y"] = 0.0,["z"] = -0.03,["xR"] = 85.0,["yR"] = 0.0, ["zR"] = 96.0
	},
	...
	["npma_2022"] = {
		["model"] = "npa_trophy", ["bone"] = 18905, ["x"] = 0.1,["y"] = 0.05,["z"] = 0.0,["xR"] = -85.0,["yR"] = -80.0, ["zR"] = -80.0
	},
	...
	["props_news_mic"] = {
		["model"] = "props_news_mic", ["bone"] = 18905, ["x"] = 0.1,["y"] = 0.06,["z"] = 0.05,["xR"] = -85.0,["yR"] = -80.0, ["zR"] = -80.0
	},
  ...
  ["housesafe"] = {
	...
	["Smallsupplycrate"] = {
		["animDict"] = "anim@heists@narcotics@trash",
		["animName"] = "drop_side",
		["model"] = "ba_prop_battle_rsply_crate_gr_02a",
		["bone"] = 28422,
		["x"] = 5,
		["y"] = -0.02,
		["z"] = -0.17,
...
RegisterNetEvent('attach:np_prop_cs_walking_stick')
AddEventHandler('attach:np_prop_cs_walking_stick', function()
	TriggerEvent("attachItemPerm","np_prop_cs_walking_stick")
end)
...
AddEventHandler('animation:carry', function(item,isInventory)
	...
	if not carryingObject then
		...
		currentCarryObject = attachPropList[item]
		lastObjectHealth = 0
...
Citizen.CreateThread(function()
	while true do
		...
		if carryingObject then
			...
			local anim = "idle"
			if currentCarryObject and currentCarryObject.useCustomAnim then
				animDict = currentCarryObject.animDict
				anim = currentCarryObject.animName
			end
			...
			if not IsEntityPlayingAnim(PlayerPedId(), animDict, anim, 3) then
				TaskPlayAnim(PlayerPedId(), animDict, anim, 8.0, -8, -1, carryAnimType, 0, 0, 0, 0)
				canceled = false
			end
		else
			if IsEntityPlayingAnim(PlayerPedId(), animDict, anim, 3) and not canceled then
		...
		if holding ~= "none" then
			...
			elseif attachPropList[holding] ~= nil and not attachPropList[holding].destroyOnDamage then
				...
				if isColliding then
					...
					exports["wounds"]:setEntityHealth(ped, playerHealth - 5)
