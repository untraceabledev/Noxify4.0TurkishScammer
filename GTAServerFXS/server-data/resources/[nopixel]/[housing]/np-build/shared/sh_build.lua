...
Build.Plans = {
	...
	["empty_house2"] = {
		...
		["saveClient"] = false,
		["origin"] = false,
		["spawnOffset"] = vector3(-0.33,-7.05,-4.62),
		["interact"] = {
			[1] = {
				["offset"] = vector3(-0.33,-7.05,-4.62),
				["viewDist"] = 2.0,
				["useDist"] = 2.0,
				["generalUse"] = {"",""},
				["housingMain"] = {"to leave.","housing:frontdoor"},
	...
	["empty_house3"] = {
		...
		["saveClient"] = false,
		["origin"] = false,
		["spawnOffset"] = vector3(0.13,-3.34,-1.81),
		["interact"] = {
			[1] = {
				["offset"] = vector3(0.13,-3.34,-1.81),
				["viewDist"] = 2.0,
				["useDist"] = 2.0,
				["generalUse"] = {"",""},
				["housingMain"] = {"to leave.","housing:frontdoor"},
