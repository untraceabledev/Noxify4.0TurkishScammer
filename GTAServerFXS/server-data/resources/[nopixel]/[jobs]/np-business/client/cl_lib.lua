...
local employedDebugMode = false
RegisterCommand("toggleEmployedDebugMode", function()
    employedDebugMode = not employedDebugMode
end, false)
function IsEmployedAt(pBusiness)
    if employedDebugMode and GetConvar("sv_environment", "prod") == "debug" then
        return true
    end
