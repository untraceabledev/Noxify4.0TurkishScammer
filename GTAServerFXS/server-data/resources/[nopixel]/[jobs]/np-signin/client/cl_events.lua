...
RegisterNetEvent("np-signin:signOffDuty")
AddEventHandler("np-signin:signOffDuty", function()
  signOff()
end)
...
AddEventHandler("np-signin:peekAction", function(pArgs, pEntity, pContext)
  ...
  if name ~= "officer_sign_in" and name ~= "ems_sign_in" and name ~= "ems_volunteer_sign_in" and name ~= "public_services_sign_in"  then return end
