...
exports('HasSyncFlag', HasSyncFlag)
...
exports('ToggleNeonLights', ToggleNeonLights)
...
exports('SetLightIndicators', SetLightIndicators)
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        local netId = (not CurrentNetworkId or CurrentNetworkId == 0) and NetworkGetNetworkIdFromEntity(pVehicle) or
            CurrentNetworkId
...
Citizen.CreateThread(function()
    exports["np-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights",
        "-toggleNeonLights")
    exports["np-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator",
        "-toggleRightIndicator")
    exports["np-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator",
        "-toggleLeftIndicator")
    exports["np-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights",
        "-toggleHazardLights")
end)
